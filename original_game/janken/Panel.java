...
public class Panel {
	...
	public static void createPanel(JFrame frame) {
		...
		JPanel headerPanel = setPanel(Color.BLUE, headerPanelDimension);
		headerLabel = new JLabel("「じゃんけんで勝負！」");
		...
		contentsLabel = setFont(Color.BLUE,contentsLabel,54);
		contentsPanel.add(contentsLabel);
		frame.add(contentsPanel,BorderLayout.CENTER);
		
		//フッタパネル
		Dimension footerPanelDimension = new Dimension(640, 50);
		JPanel footerPanel = setPanel(Color.BLUE,footerPanelDimension);
	...
	public static JLabel setFont(Color clr,JLabel label,int strSize) {
		...
		Font labelFont = new Font("ＭＳ 明朝",Font.PLAIN,strSize);
